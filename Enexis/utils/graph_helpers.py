...
def get_ts_plot(df_1, yaxis_label = ' ', xaxis_label = 'TimeFrame', hover_mode = 'x', 
    ...
    layout = go.Layout (
            ...
            margin = dict(l = 50, r = 10, t = 15, b = 40))
...
def get_ts_plot_2(df_1, df_2, title = 'Anomaly Detection', yaxis_label = ' ', xaxis_label = 'TimeFrame', hover_mode = 'closest'):
    ...
    layout = go.Layout (
            ...
            showlegend = True,
            yaxis = dict(title = yaxis_label, titlefont = dict(color = '#0e4886'), tickformat = '.2f'), 
            margin = dict(l = 90, r = 10, t = 15, b = 40))
        
    fig = go.Figure (data = [d1,d2], layout = layout)
    return fig

def get_ts_plot_outlier(df_1, df_2, yaxis_label = ' MAD', hover_mode = 'closest'):   
    d1 = go.Scattergl(
            x = df_1.index.tz_localize('UTC').tz_convert('US/Eastern'), 
            y = df_1.round(2), 
            text = df_1.index,
    ...
    layout = go.Layout ( 
                        legend_orientation = 'h',
                        legend = dict(x = 0, y = 1.2, font = dict(size = 8)),
                        hovermode = hover_mode,
                        yaxis = dict(title = yaxis_label, titlefont = dict(color = '#0e4886')),
                        font = dict(size = 10), 
                        margin = dict(l = 45, r = 10, t = 15, b = 40))
    
    fig = go.Figure (data = [d1,d2], layout = layout)
    return fig

def get_box_plot(df_trans, y_label = 'Temperature [°C]', legend_bool = True):
    ...
    layout = go.Layout (
            ...
            font = dict(size = 8), margin = dict(l = 60, r = 5, t = 30, b = 30)
            )
    fig = go.Figure (data = traces, layout = layout)
    return fig
...
def get_heatmap(df_1, x_value, y_value, measurement_names, x_title = '', y_title = ''):
